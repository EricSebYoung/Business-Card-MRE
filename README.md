...
* VSCode: `Shift+Ctrl+B`, then select 'build Business-Card-MRE'.

## Run

* Command line: `npm start`.
* VSCode: Switch to the 'Run' tab (`Ctrl+Shift+D` will open it), select 'Launch Business-Card-MRE project' from the dropdown at the top, and then `F5` to start it.
